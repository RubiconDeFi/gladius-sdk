...
export interface GladiusOrderQuoterInterface extends utils.Interface {
  functions: {
    "getReactor(bytes)": FunctionFragment;
    "quote(bytes,bytes,uint256)": FunctionFragment;
...
export interface GladiusOrderQuoter extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GladiusOrderQuoterInterface;
