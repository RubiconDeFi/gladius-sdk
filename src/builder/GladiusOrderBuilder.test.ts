...
describe("GladiusOrderBuilder", () => {
  ...
  beforeEach(() => {
    builder = new GladiusOrderBuilder(1);
  });
  ...
  it("Regenerates builder from order", () => {
    ...
    const regenerated = GladiusOrderBuilder.fromOrder(order).build();
  ...
  it("Regenerates builder allows modification", () => {
    ...
    const regenerated = GladiusOrderBuilder.fromOrder(order)
  ...
  it("Unknown chainId", () => {
    ...
    expect(() => new GladiusOrderBuilder(chainId)).toThrow(
