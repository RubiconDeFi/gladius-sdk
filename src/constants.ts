...
export const ORDER_QUOTER_MAPPING: { readonly [key: number]: string } = {
  ...
  137: "0x56e43695d183dcFa9D8fE95E796227A491627Fd9",
...
export const ORDER_MINIMUM: { readonly [x: number]: { [token: string]: string }  } = {
  ...
  [ChainId.BASE]: {
    '0x4200000000000000000000000000000000000006': '2200000000000000', // WETH
    '0x2Ae3F1Ec7F1F5012CFEab0185bfc7aa3cf0DEc22': '2200000000000000', // cbETH
    '0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913': '5000000', // USDC
    '0xd9aAEc86B65D86f6A7B5B1b0c42FFA531710b6CA': '5000000', // USDCbC
    '0x50c5725949A6F0c72E6C4a641F24049A917DB0Cb': '5000000000000000000', // DAI
  }
};
